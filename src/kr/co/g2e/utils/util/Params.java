...
public class Params {
	...
	public static Params getParams(HttpServletRequest request) {
		...
		params.requestBody = getBody(request);
	...
	public String[] putString(String key, String value) {
		return parameterMap.put(key, new String[] { value });
	}
	...
	private static String getBody(HttpServletRequest request) {
		...
		try {
			...
			if (is != null) {
				buf.append(IOUtils.toString(request.getInputStream()));
			} else {
				buf.append("");
			}
		} catch (IOException e) {
